(function () {
    ...
    function APICartService($http, $q, $timeout, CacheFactory, ENUM) {
        ...
        function _get( params ) {
            return this.fetch( '/v2/sdtapi.cart.get', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? res.data.goods_groups : null;
            });
        }

        function _add( params ) {
            return this.fetch( '/v2/sdtapi.cart.add', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? true : false;
            });
        }

        function _delete( params ) {
            return this.fetch( '/v2/sdtapi.cart.delete', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? true : false;
            });
        }

        function _update( params ) {
            return this.fetch( '/v2/sdtapi.cart.update', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? true : false;
            });
        }

        function _clear( params ) {
            return this.fetch( '/v2/sdtapi.cart.clear', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? true : false;
            });
        }

        function _promos( params ) {
            return this.fetch( '/v2/sdtapi.cart.promos', params, false, function(res){
                return ENUM.ERROR_CODE.OK == res.data.error_code ? res.data.cart_product_promos : null;
            });
        }

        function _checkout( params ) {
            return this.fetch( '/v2/sdtapi.cart.checkout', params, false, function(res){
